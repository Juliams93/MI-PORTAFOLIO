...
const archive = [
  { name: "FitReserve Gym", type: "Web personalizada · Diseño funcional", description: "Experiencia de reservas creada a medida para un gimnasio: acceso de miembros, calendario de clases, disponibilidad y listas de espera, gestión de reservas, perfil personal y panel de administración para organizar horarios y crear nuevas clases. Diseñada con React, TypeScript, Vite y una interfaz responsive." },
