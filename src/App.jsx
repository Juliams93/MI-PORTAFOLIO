  ...
  return <div className="site-shell">
    ...
    <main>
      ...
      <section className="roadmap section" id="roadmap">
        ...
        <div className="learning-now"><span>Actualmente formándome en →</span><strong>Máster en Inteligencia Artificial</strong><ArrowRight size={15}/><strong>Azure</strong><ArrowRight size={15}/><strong>UX/UI</strong><ArrowRight size={15}/><strong>Application Security</strong></div>
      </section>
